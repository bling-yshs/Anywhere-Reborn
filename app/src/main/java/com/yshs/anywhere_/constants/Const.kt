...
object Const {
  ...
  const val SP_NAME = "com.yshs.anywhere__preferences"
  const val SP_NAME_DEBUG = "com.yshs.anywhere_.debug_preferences"
  ...
  const val DEFAULT_BR_ACTION = "com.yshs.anywhere_.BROADCAST"
}
