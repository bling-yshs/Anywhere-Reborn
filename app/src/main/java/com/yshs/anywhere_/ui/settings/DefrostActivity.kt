...
import com.yshs.anywhere_.adapter.defrost.DefrostAdapter
import com.yshs.anywhere_.adapter.defrost.DefrostItem
import com.yshs.anywhere_.constants.Const
import com.yshs.anywhere_.databinding.ActivityDefrostBinding
import com.yshs.anywhere_.receiver.AdminReceiver
import com.yshs.anywhere_.utils.ToastUtil
import com.yshs.anywhere_.utils.manager.DialogManager.showGrantPrivilegedPermDialog
...
class DefrostActivity : AppBarActivity<ActivityDefrostBinding>() {
            ...
            setOnItemChildClickListener { _, view, position ->
                if (view.id == R.id.button) {
                    if (mList[position].mode == Const.DEFROST_MODE_DSM) {
                        if (com.yshs.anywhere_.utils.AppUtils.atLeastO()) {
                            try {
    ...
    private fun initData() {
        mList = if (com.yshs.anywhere_.utils.AppUtils.atLeastO()) {
            listOf(
